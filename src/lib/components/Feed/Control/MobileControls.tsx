    ...
    <div className={styles.playerVideoMobile}>
      {firstTimeMuted ? (
        <div
          ...
          aria-label="Player Video Mobile Muted"
        >
      ...
      <Fragment>
        <div
          ...
          aria-label="Player video mute button"
          data-visible={
        ...
        {isFinalized && (
          ...
          >
            <input
              ...
              min="0"
              max="100"
              aria-label="Player Video Progress Bar"
              value={progress}
        ...
        <div
          ...
          aria-label="Player video like button"
        >
        ...
        >
          ...
          >
            <div
              ...
              aria-label="Player video fullscreen button"
            >
              {fullScreen ? (
            ...
            <div
              ...
              aria-label="Player mobile share button"
            >
              {fullScreen ? (
            ...
            {!!videoEl?.current?.requestPictureInPicture && (
              <div
                ...
                aria-label="Player video picture and picture button"
              >
                {!!videoEl?.current?.requestPictureInPicture &&
                getMobileOS() !== 'Android' ? (
                  pictureInPicture ? (
